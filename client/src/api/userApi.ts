...
const BASE_URL = "https://carparking-backend.onrender.com/api/users"; // Base API URL
const REGISTER_URL = "https://carparking-backend.onrender.com/api/register/"; // User registration endpoint
